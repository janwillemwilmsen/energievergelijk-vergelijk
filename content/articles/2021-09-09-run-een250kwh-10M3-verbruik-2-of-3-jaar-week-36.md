...
title:  Energiecontract, 1 jaar met laagverbruik (250kWh, 10M3)  
description: Vergelijk nu de prijzen van een energiecontract van 1 jaar - laagverbruik  
image: /logo.png  
energieleverancier-url:  2021-09-09-run-een  
looptijdcontract: een  
elektriciteitverbruik: 250  
gasverbruik: 10  
postcode: 1097BB  
huisnummer: 14  
createdAt: Thu Sep 09 2021 07:38:57 GMT+0200 (GMT+02:00)  
createdAt2: 2021-8-9  
---
<div class="bg-white rounded mt-10 p-2 text-lg">Op 9 September 2021 hebben we een vergelijking voor je gemaakt tussen 5 energievergelijkers.<br><br><strong>Om eerlijk te vergelijken hebben we telkens dezelfde looptijd en hetzelfde verbruik vergeleken.</strong><ul>
...
<div class="table-cell p-1  pr-4 border-b border-gray-200">Anode Energie Grijze Stroom en Gas 1 jaar Vast</div>
<div class="table-cell p-1 border-b border-gray-200">€ -0,08</div>
</div>
...
<div class="table-cell p-1 border-b border-gray-200">€ 1,48</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200">3</div>
<div class="table-cell p-1  pr-4 border-b border-gray-200">om | nieuwe energie Nederlandse Groene stroom en CO2-gecompenseerd Gas 1 jaar Vast</div>
<div class="table-cell p-1 border-b border-gray-200">€ 2,38</div>
</div>
</div>
</div>
...
<div class="table-cell p-1 pr-3  md:pr-2  border-b border-gray-200">€ -5 per maand € -55 per jaar</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200">2 Powerpeers</div>
<div class="table-cell p-1 border-b border-gray-200">nb</div>
<div class="table-cell p-1 pr-3  md:pr-2 border-b border-gray-200">€ -3 per maand € -41 per jaar</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200">3 FENOR</div>
<div class="table-cell p-1 border-b border-gray-200">nb</div>
<div class="table-cell p-1 pr-10 sm:pr-5  md:pr-2 border-b border-gray-200">€ 0 per maand € 3 per jaar</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell p-1 border-b border-gray-200">AltijdVoordeel 1 jaar vast</div>
<div class="table-cell p-1 border-b border-gray-200">€ -7,48</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
...
<div class="table-cell p-1 border-b border-gray-200">€ -4,46</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200 ">3 Powerpeers</div>
<div class="table-cell p-1 border-b border-gray-200">Samen Groen 1 jaar vast</div>
...
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200 ">3 GreenNL</div>
<div class="table-cell p-1 pr-4 border-b border-gray-200">Groene stroom + CO2-gecompenseerd Gas 3 jaar vast Actie</div>
<div class="table-cell p-1 border-b border-gray-200">− € 1,39</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell p-1 border-b border-gray-200">kosten p.m. €-4,63 € -55,50/jaar</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200">2</div>
<div class="table-cell p-1 border-b border-gray-200">Powerpeers</div>
<div class="table-cell p-1 border-b border-gray-200">kosten p.m. €-3,42 € -41,00/jaar</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 border-b border-gray-200">3</div>
<div class="table-cell p-1 border-b border-gray-200">DELTA</div>
<div class="table-cell p-1 border-b border-gray-200">kosten p.m. €0,15 € 1,78/jaar</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
