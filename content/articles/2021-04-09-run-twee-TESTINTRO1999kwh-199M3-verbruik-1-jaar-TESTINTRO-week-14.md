...
<div class="table-cell border-b border-gray-200">€ 39,41</div>
</div>
...
<div class="table-cell border-b border-gray-200">€ 40,01</div>
</div>
...
<div class="table-cell border-b border-gray-200">€ 40,95</div>
</div>
</div>
</div>
...
<div class="table-cell border-b border-gray-200">€ 28 per maand € 335 per jaar</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">2 Energiedirect</div>
<div class="table-cell border-b border-gray-200">nb</div>
<div class="table-cell border-b border-gray-200">€ 31 per maand € 366 per jaar</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">3 Energiedirect</div>
<div class="table-cell border-b border-gray-200">nb</div>
<div class="table-cell border-b border-gray-200">€ 31 per maand € 377 per jaar</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell border-b border-gray-200">kosten p.m. €27 ,90 € 334,74 / jaar</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">2</div>
<div class="table-cell border-b border-gray-200">Energiedirect.nl</div>
<div class="table-cell border-b border-gray-200">kosten p.m. €30 ,53 € 366,41 / jaar</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">3</div>
<div class="table-cell border-b border-gray-200">Energiedirect.nl</div>
<div class="table-cell border-b border-gray-200">kosten p.m. €31 ,38 € 376,57 / jaar</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell border-b border-gray-200">Van € 45,- voor € 34,-/mnd Jaarkosten € 539,- € 414,- Voorgesteld termijnbedrag € 45,-</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell border-b border-gray-200">€ 56,56 per maand</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
...
<div class="table-cell border-b border-gray-200">€ 53,40 per maand</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">Vandebron</div>
<div class="table-cell border-b border-gray-200">Variabel</div>
<div class="table-cell border-b border-gray-200">€ 51,97 per maand</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell border-b border-gray-200">€ 55,83per maand</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200 ">Eneco</div>
<div class="table-cell border-b border-gray-200">1 Jaar</div>
<div class="table-cell border-b border-gray-200">€ 53,05per maand</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200 ">Eneco</div>
<div class="table-cell border-b border-gray-200">3 jaar</div>
<div class="table-cell border-b border-gray-200">€ 52,93per maand</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
...
<div class="table-cell border-b border-gray-200">€55,- /mnd</div>
</div>
<div class="table-row result-two hover:bg-gray-100">
...
<div class="table-cell border-b border-gray-200">van €55,- voor  €43,- /mnd</div>
</div>
<div class="table-row result-three hover:bg-gray-100">
<div class="table-cell p-1 pl-2 border-b border-gray-200">Essent Groene Stroom & Gas Zeker</div>
<div class="table-cell border-b border-gray-200">+ €150,- cashback</div>
<div class="table-cell border-b border-gray-200">van €55,- voor  €42,- /mnd</div>
</div>
</div>
</div>
<div x-data="{show:false}" class="mt-2 print:hidden">
