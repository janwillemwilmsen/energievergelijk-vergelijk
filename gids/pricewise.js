...
const bedrijf                   = config[9];
const seotitle                  = config[9].seotitle;
const metadescription           = config[9].metadescription;
const bedrijfsnaam              = config[9].naam;    
const bedrijfswebsite           = config[9].www;    
const bedrijfstitle             = config[9].title;    
const bedrijfsafbeelding        = config[9].image;    
const bedrijfsparagraaf1        = config[9].paragraaf;    
const bedrijfsveld1             = config[9].freeformat1;    
const bedrijfsveld2             = config[9].freeformat2;    
const bedrijfsveld3             = config[9].freeformat3;    
const bedrijfsveld4             = config[9].freeformat4; 
const bedrijfsveld5             = config[9].freeformat5;    
const bedrijfsveld6             = config[9].freeformat6;   

const bedrijfsgoogle            = config[9].google;    
const bedrijfsfacebook          = config[9].facebook;    
const bedrijfstwitter           = config[9].twitter;    
const bedrijfsyoutube           = config[9].youtube;    
const bedrijfsinstagram         = config[9].instagram;    
const bedrijfstrustpilot        = config[9].trustpilot;    
const bedrijfsklachtnl          = config[9].klachtnl;    
const bedrijfsalexa             = config[9].alexa;    
const bedrijfsklantenvertellen  = config[9].klantenvertellen;    
const bedrijfsinsta2            = config[9].instragram2;    
const bedrijfsyout2             = config[9].youtube2;    
const bedrijfsface2             = config[9].facebook2;    
const bedrijfstwit2             = config[9].twitter2;    
const bedrijfsyttitle           = config[9].youtubevideotitel;    

const bedrijfsytintro           = config[9].youtubevideotjeintro;    
const bedrijfsytvid             = config[9].youtubevideotje;   
...
fs.appendFileSync(`${appRoot}/content/gids/${bedrijfsnaam}` + '.md', stringpricewise);
// pricewise END
