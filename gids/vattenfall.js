...
const bedrijf                   = config[4];
const seotitle                  = config[4].seotitle;
const metadescription           = config[4].metadescription;
const bedrijfsnaam              = config[4].naam;    
const bedrijfswebsite           = config[4].www;    
const bedrijfstitle             = config[4].title;    
const bedrijfsafbeelding        = config[4].image;    
const bedrijfsparagraaf1        = config[4].paragraaf;    
const bedrijfsveld1             = config[4].freeformat1;    
const bedrijfsveld2             = config[4].freeformat2;    
const bedrijfsveld3             = config[4].freeformat3;    
const bedrijfsveld4             = config[4].freeformat4;    
const bedrijfsveld5             = config[4].freeformat5;    
const bedrijfsveld6             = config[4].freeformat6;   

const bedrijfsgoogle            = config[4].google;    
const bedrijfsfacebook          = config[4].facebook;    
const bedrijfstwitter           = config[4].twitter;    
const bedrijfsyoutube           = config[4].youtube;    
const bedrijfsinstagram         = config[4].instagram;    
const bedrijfstrustpilot        = config[4].trustpilot;    
const bedrijfsklachtnl          = config[4].klachtnl;    
const bedrijfsalexa             = config[4].alexa;    
const bedrijfsklantenvertellen  = config[4].klantenvertellen;    
const bedrijfsinsta2            = config[4].instragram2;    
