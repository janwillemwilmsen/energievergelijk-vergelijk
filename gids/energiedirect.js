...
const bedrijf                   = config[3];
const seotitle                  = config[3].seotitle;
const metadescription           = config[3].metadescription;
const bedrijfsnaam              = config[3].naam;    
const bedrijfswebsite           = config[3].www;    
const bedrijfstitle             = config[3].title;    
const bedrijfsafbeelding        = config[3].image;    
const bedrijfsparagraaf1        = config[3].paragraaf;    
const bedrijfsveld1             = config[3].freeformat1;    
const bedrijfsveld2             = config[3].freeformat2;    
const bedrijfsveld3             = config[3].freeformat3;    
const bedrijfsveld4             = config[3].freeformat4;    
const bedrijfsveld5             = config[3].freeformat5;    
const bedrijfsveld6             = config[3].freeformat6;    


const bedrijfsgoogle            = config[3].google;    
const bedrijfsfacebook          = config[3].facebook;    
const bedrijfstwitter           = config[3].twitter;    
const bedrijfsyoutube           = config[3].youtube;    
const bedrijfsinstagram         = config[3].instagram;    
const bedrijfstrustpilot        = config[3].trustpilot;    
const bedrijfsklachtnl          = config[3].klachtnl;    
const bedrijfsalexa             = config[3].alexa;    
const bedrijfsklantenvertellen  = config[3].klantenvertellen;    
const bedrijfsinsta2            = config[3].instragram2;    
