...
const bedrijf                   = config[2];
const seotitle                  = config[2].seotitle;
const metadescription           = config[2].metadescription;
const bedrijfsnaam              = config[2].naam;    
const bedrijfswebsite           = config[2].www;    
const bedrijfstitle             = config[2].title;    
const bedrijfsafbeelding        = config[2].image;    
const bedrijfsparagraaf1        = config[2].paragraaf;    
const bedrijfsveld1             = config[2].freeformat1;    
const bedrijfsveld2             = config[2].freeformat2;    
const bedrijfsveld3             = config[2].freeformat3;    
const bedrijfsveld4             = config[2].freeformat4; 
const bedrijfsveld5             = config[2].freeformat5;    
const bedrijfsveld6             = config[2].freeformat6;   

const bedrijfsgoogle            = config[2].google;    
const bedrijfsfacebook          = config[2].facebook;    
const bedrijfstwitter           = config[2].twitter;    
const bedrijfsyoutube           = config[2].youtube;    
const bedrijfsinstagram         = config[2].instagram;    
const bedrijfstrustpilot        = config[2].trustpilot;    
const bedrijfsklachtnl          = config[2].klachtnl;    
const bedrijfsalexa             = config[2].alexa;    
const bedrijfsklantenvertellen  = config[2].klantenvertellen;    
const bedrijfsinsta2            = config[2].instragram2;    
const bedrijfsyout2             = config[2].youtube2;    
const bedrijfsface2             = config[2].facebook2;    
const bedrijfstwit2             = config[2].twitter2;    
const bedrijfsyttitle           = config[2].youtubevideotitel;    

const bedrijfsytintro           = config[2].youtubevideotjeintro;    
const bedrijfsytvid             = config[2].youtubevideotje;   
...
fs.appendFileSync(`${appRoot}/content/gids/${bedrijfsnaam}` + '.md', stringindepender);
// independer END
