...
const bedrijfsafbeelding        = config[7].image;    
const bedrijfsparagraaf1        = config[7].paragraaf;    
const bedrijfsveld1             = config[7].freeformat1;    
const bedrijfsveld2             = config[7].freeformat2;    
const bedrijfsveld3             = config[7].freeformat3;    
const bedrijfsveld4             = config[7].freeformat4; 
const bedrijfsveld5             = config[7].freeformat5;    
const bedrijfsveld6             = config[7].freeformat6;   

const bedrijfsgoogle            = config[7].google;    
const bedrijfsfacebook          = config[7].facebook;    
const bedrijfstwitter           = config[7].twitter;    
const bedrijfsyoutube           = config[7].youtube;    
const bedrijfsinstagram         = config[7].instagram;    
const bedrijfstrustpilot        = config[7].trustpilot;    
const bedrijfsklachtnl          = config[7].klachtnl;    
const bedrijfsalexa             = config[7].alexa;    
const bedrijfsklantenvertellen  = config[7].klantenvertellen;    
const bedrijfsinsta2            = config[7].instragram2;    
const bedrijfsyout2             = config[7].youtube2;    
const bedrijfsface2             = config[7].facebook2;    
const bedrijfstwit2             = config[7].twitter2;    
const bedrijfsyttitle           = config[7].youtubevideotitel;    

const bedrijfsytintro           = config[7].youtubevideotjeintro;    
...
fs.appendFileSync(`${appRoot}/content/gids/${bedrijfsnaam}` + '.md', stringeasyswitch);
// easyswitch END
