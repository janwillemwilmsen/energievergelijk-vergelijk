...
<section class="bg-gray-200 bg-cover border-b border-white border-opacity-50 " style="background-image: url(/mac.jpg)">
...
<script>
  ...
  async fetch() {
    ...
    //   const bedrijven = await $content('gids', params.slug)
    //     .only(['title', 'introtekst', 'logo', 'slug', 'author'])
